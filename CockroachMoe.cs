/*
name: Cockroach Moe
description: This script farms almost all endgame gear, with an option to farm ArchMage alongside.
tags: null
*/
#region cs_include
...
//Classes
    ...
    // VDK -> Awescended ->  Helm ->(AM 5, 6) -> Cape Ench -> Elysium -> Ultra Prereqs -> AM -> NSoD
    ...
    public void CockroachMoeCore()
    {
        ...
        if (!Core.isCompletedBefore(8821))
        {
            ...
            //Ravenous Unidentifieds
            Core.AddDrop("Unidentified 21");
            Core.AddDrop("Unidentified 36");
            // needs 25 for archfiend ench orbs
        ...
        //Check for Ravenous
        Core.Logger("Checking if Ravenous (Enchantment) is unlocked");
        forgeUnlocks.Ravenous();
        Core.Logger("Ravenous unlocked, continuing");
    ...
    public void CheckEssentials()
    {
        ...
        Core.ToBank("Blade of Awe", "ArchPaladin");
    }
